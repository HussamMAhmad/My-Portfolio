...
import ButtonIn from "@/components/ui/buttonIn/buttonIn";
    ...
    >
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 w-full">
        <div className="relative w-full max-w-100 aspect-square flex items-center justify-center">
          <div className="absolute inset-0 rounded-full border-2 border-dashed border-main animate-spin-slow w-[95%] h-[95%] top-[50%] left-[50%]" />
        ...
        <div className="flex-1 lg:max-w-[650px] flex flex-col items-start">
          ...
          <div
            className={`overflow-hidden transition-all ease-in-out duration-300 ${isExpanded ? "animate-fadeIn max-h-70" : "animate-fadeout max-h-0"}`}
          >
            <p className="text-[14px] sm:text-[16px] text-text/80 leading-relaxed mb-4">
