...
function Home() {
  return (
    <div id="home" className="px-[10px] sm:px-20 lg:py-30 max-lg:py-[100px] h-screen w-full relative">
      <div className="lg:max-w-[55%] max-lg:w-fll flex flex-col justify-between items-start h-full">
        <div>
          <h1 className="relative text-[24px] sm:text-[42px] font-bold mb-[10] mt-[10] text-text">
